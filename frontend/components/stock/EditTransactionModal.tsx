      ...
      <div className="w-full max-w-sm rounded-xl bg-surface p-6 shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
          ...
          {supplierId && (
            <>
              <div>
                <label className="mb-1 block text-sm font-medium text-text-base">سعر الوحدة <span className="text-red-500">*</span></label>
                <input
              ...
              <div>
                <label className="mb-1 block text-sm font-medium text-text-base">الإجمالي المدفوع (دج)</label>
                <input
