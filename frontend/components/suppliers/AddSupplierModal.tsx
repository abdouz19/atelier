    ...
    <AppModal
      ...
      footer={
        <>
          ...
          <button type="submit" form="add-supplier-form" disabled={submitting} className="rounded-lg bg-primary-500 px-4 py-2 text-sm font-medium text-white hover:bg-primary-600 disabled:opacity-60">
